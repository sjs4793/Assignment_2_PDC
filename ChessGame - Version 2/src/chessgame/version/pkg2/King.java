...
//        }
    ...
    public void appearance() {
        if (isPlayerOne()){
            setIcon(new ImageIcon("/Users/pulinangurala/IdeaProjects/PDC - Chess Game 2/fancy/BK.gif"));
        }
        else{
            setIcon(new ImageIcon("/Users/pulinangurala/IdeaProjects/PDC - Chess Game 2/fancy/WK.gif"));
        }
    }
