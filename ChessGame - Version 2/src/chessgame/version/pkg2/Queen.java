...
//                        getGameMap()[i - a][j + a].setInRange(true);
    ...
    public void appearance() {
        if (isPlayerOne()){
            setIcon(new ImageIcon("/Users/pulinangurala/IdeaProjects/PDC - Chess Game 2/fancy/BQ.gif"));
        }
        else{
            setIcon(new ImageIcon("/Users/pulinangurala/IdeaProjects/PDC - Chess Game 2/fancy/WQ.gif"));
        }
    }
