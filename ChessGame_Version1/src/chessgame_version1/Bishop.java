...
//                        getGameMap()[i - a][j + a].setInRange(true);
    ...
    public void appearance() {
        if (isPlayerOne()){
            setIcon(new ImageIcon("C:\\Users\\sjs4793\\Documents\\NetBeansProjects\\Chess Game Version 1\\src\\fancy\\BB.gif"));
        }
        else{
            setIcon(new ImageIcon("C:\\Users\\sjs4793\\Documents\\NetBeansProjects\\Chess Game Version 1\\src\\fancy\\WB.gif"));
        }
    }
