...
//                }
    ...
    public void appearance() {
        if (isPlayerOne() && getPieceType().equals(PieceType.PAWN)){
            setIcon(new ImageIcon("C:\\Users\\sjs4793\\Documents\\NetBeansProjects\\Chess Game Version 1\\src\\fancy\\BP.gif"));
        }
        else{
            if(getPieceType().equals(PieceType.PAWN)) {
                setIcon(new ImageIcon("C:\\Users\\sjs4793\\Documents\\NetBeansProjects\\Chess Game Version 1\\src\\fancy\\WP.gif"));
            }
        }
    }
